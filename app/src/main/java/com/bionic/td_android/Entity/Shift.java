...
public class Shift implements TextWatcher{
    ...
    public void populateView(){
        ...
        totalPausefield.setText(pause / 3600000 + "h " + ((pause / 60000) % 60)  +"m");

        for (Ride ride : rides) {
            View next = ride.getViewPresentation(view.getContext(),manager);
            ridesContainer.addView(next);
        }
    }
